...
{  
    ...
    {  
        ...
        private void ConfigureTlsCertificate()
        {
            try
            {
                ...
                {
                    _serverCertificate = CertificateHelper.LoadCertificateFromStore(
                ...
                if (_certificateValidator != null)
                {
                    ...
                    if (!_certificateValidator.ValidateCertificate(_serverCertificate, chain, SslPolicyErrors.None))
                    {
                ...
                {
                    _certificatePinningService.AddCertificatePin(_serverCertificate, true);
                ...
                try 
                {
                    ...
                    var httpsBinding = new HttpListenerTimeoutManager
                    {
                        IdleConnection = TimeSpan.FromMinutes(5),
                        HeaderWait = TimeSpan.FromSeconds(30),
                        RequestQueue = TimeSpan.FromMinutes(2)
                    };
                    
                    _httpListener.TimeoutManager = httpsBinding;
        ...
        {  
            ...
            {  
                ...
                {
                    if (!_tlsConnectionManager.TryAddConnection(clientIp))
                    {
                ...
                if (_options.UseTls && _options.RequireClientCertificate)
                {
                    ...
                    if (_certificateValidator != null)
                    {
                        ...
                        if (!_certificateValidator.ValidateClientCertificate(
                            this, clientCertificate, chain, SslPolicyErrors.None))
                        {
